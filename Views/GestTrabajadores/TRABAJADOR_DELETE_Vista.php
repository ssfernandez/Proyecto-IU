...
<ul class="dropdown-menu" role="menu" id="contBandera">
            ...
            <?php
            echo '<li class="contBandera"><a href="../../Controllers/TRABAJADORES_Controller.php?idioma=esp&acc=¿Borrar?&ocup='.$ocup.'"><IMG SRC="../../Assets/img/bespanha.gif" class="bandera"> Esp </a></li>';
            echo '<li class="contBandera"><a href="../../Controllers/TRABAJADORES_Controller.php?idioma=eng&acc=¿Borrar?&ocup='.$ocup.'"><IMG SRC="../../Assets/img/buk.gif" class="bandera"> Eng </a></li>';
            ?>
          </ul>
        </div>
...
<?php
	...
	<div>
		...
		<!-- Form Name -->
			...
			<legend><?=TITULO_DELETE_TRABAJ?></legend>
          	...
          	<tbody >
				...
				?>
						<tr>
						  	...
						  	<td align="center" >
						  	<?php
	                			echo '<a class="btn btn btn-danger glyphicon glyphicon-trash" href="../../Controllers/TRABAJADORES_Controller.php?acc=Borrar&dni='.$aux[0].'&ocup='.$ocup.'"></em></a>';
	                			echo '<a class="btn btn btn-info glyphicon glyphicon-home" href="../../Controllers/TRABAJADORES_Controller.php?acc=Cancelar&dni='.$aux[0].'&ocup='.$ocup.'"></em></a>';
	                		?>
	            			</td>
						</tr>			    
                 </tbody>
