...
<ul class="dropdown-menu" role="menu" id="contBandera">
            ...
            <?php
            echo '<li class="contBandera"><a href="../../Controllers/DESCUENTO_Controller.php?idioma=esp&acc=¿Borrar?&coddes='.$coddes.'"><IMG SRC="../../Assets/img/bespanha.gif" class="bandera"> Esp </a></li>';
            echo '<li class="contBandera"><a href="../../Controllers/DESCUENTO_Controller.php?idioma=eng&acc=¿Borrar?&coddes='.$coddes.'"><IMG SRC="../../Assets/img/buk.gif" class="bandera"> Eng </a></li>';
            ?>
          </ul>
        </div>
