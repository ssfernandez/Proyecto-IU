...
<ul class="dropdown-menu" role="menu" id="contBandera">
            ...
            <?php
            echo '<li class="contBandera"><a href="../../Controllers/RESERVAS2_Controller.php?idioma=esp&acc=Consultar&idr='.$idr.'"><IMG SRC="../../Assets/img/bespanha.gif" class="bandera"> Esp </a></li>';
            echo '<li class="contBandera"><a href="../../Controllers/RESERVAS2_Controller.php?idioma=eng&acc=Consultar&usr='.$idr.'"><IMG SRC="../../Assets/img/buk.gif" class="bandera"> Eng </a></li>';
            ?>
          </ul>
        </div>
	...
	<div class="col-xs-15">
		<table class="table table-striped table-bordered table-list " id="tablaConsultaReservas">
                ...
                echo "<td id='textoConsultReserv' align='center'>".$aux[2]."</td>";
						  	...
						  	<td align="center" >
						  	<?php
	                			echo '<a class="btn btn-default glyphicon glyphicon-pencil" href="../../Controllers/RESERVAS2_Controller.php?acc=Modificar&idr='.$idr.'"></em></a>';
	                			echo '<a class="btn btn-default glyphicon glyphicon-trash" href="../../Controllers/RESERVAS2_Controller.php?acc=¿Borrar?&idr='.$idr.'"></em></a>';
	                		?>
	            			</td>
						</tr>
                 </tbody>
