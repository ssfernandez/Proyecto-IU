...
<ul class="dropdown-menu" role="menu" id="contBandera">
            ...
            <li class="contBandera"><a href="../../Controllers/RESERVAS2_Controller.php?idioma=esp&acc=Insertar"><IMG SRC="../../Assets/img/bespanha.gif" class="bandera"> Esp </a></li>
            <li class="contBandera"><a href="../../Controllers/RESERVAS2_Controller.php?idioma=eng&acc=Insertar"><IMG SRC="../../Assets/img/buk.gif" class="bandera"> Eng </a></li>
          </ul>
        </div>
...
<div class="col-xs-8"><!-- col8 -->
	...
	<form onsubmit="return comprobarDatos()" action="../../Controllers/RESERVAS2_Controller.php" method="POST">
		<fieldset>
		<!-- Form Name -->
