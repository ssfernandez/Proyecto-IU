...
<ul class="dropdown-menu" role="menu" id="contBandera">
            ...
            <?php
            echo '<li class="contBandera"><a href="../../Controllers/CLIENTE_Controller.php?idioma=esp&acc=¿Borrar?&dni='.$dni.'"><IMG SRC="../../Assets/img/bespanha.gif" class="bandera"> Esp </a></li>';
            echo '<li class="contBandera"><a href="../../Controllers/CLIENTE_Controller.php?idioma=eng&acc=¿Borrar?&dni='.$dni.'"><IMG SRC="../../Assets/img/buk.gif" class="bandera"> Eng </a></li>';
            ?>
          </ul>
        </div>
...
<?php
    ...
    if($aceptado){
        ...
        <legend><?=TITULO_DELETE_CLIENTE?></legend></div>
        ...
        <div class="col-xs-6">
        <input style="resize:none" type="date" name="observaciones" class="form-control input-md" readonly="readonly" value="<?php echo $aux[10]; ?>">
        
        </div>

        <label class="col-xs-4 control-label" for="protec_datos"><?=LABEL_PROTEC_DATOS?></label>  
        <div class="col-xs-6">
        <input style="resize:none" type="date" name="protec_datos" class="form-control input-md" readonly="readonly" value="<?php echo $aux[15]; ?>">
        ...
        <?php
            echo '<a class="btn btn btn-danger glyphicon glyphicon-trash" href="../../Controllers/CLIENTE_Controller.php?acc=Borrar&dni='.$aux[2].'"></em></a>';
            echo '<a class="btn btn btn-info glyphicon glyphicon-home" href="../../Controllers/CLIENTE_Controller.php?acc=Cancelar&dni='.$aux[2].'"></em></a>';
        ?>
        </div>
    </div>
