...
<ul class="dropdown-menu" role="menu" id="contBandera">
            ...
            <li class="contBandera"><a href="../../Controllers/CLIENTE_Controller.php?idioma=esp&acc=Buscar"><IMG SRC="../../Assets/img/bespanha.gif" class="bandera"> Esp </a></li>
            <li class="contBandera"><a href="../../Controllers/CLIENTE_Controller.php?idioma=eng&acc=Buscar"><IMG SRC="../../Assets/img/buk.gif" class="bandera"> Eng </a></li>
          </ul>
        </div>
	...
	<div>
		<form action="../../Controllers/CLIENTE_Controller.php" method="POST">
			...
			<!-- Form Name -->
				...
				<legend><?=TITULO_SELECT_CLIENTE?></legend>
		...
		<table class="table table-striped table-bordered table-list " id="tablaConsultaUsuarios">
              	<thead>
                    <tr>
                        ...
                        <th id='textoConsultUser'><?=LABEL_SURNAME?></th>                  
              	...
              	<tbody >
						...
						for ($i=0; $i < sizeof($ax) ; $i+=3) { 
						  ...
						  <tr>
						  	...
						  	<td align="center" >
						  	<?php
                    			echo '<a class="btn btn-default glyphicon glyphicon-list-alt" href="../../Controllers/CLIENTE_Controller.php?acc=Consultar&dni='.$ax[$i].'"></em></a>'
                    		?>
                			</td>
						  </tr>
						  <?php
