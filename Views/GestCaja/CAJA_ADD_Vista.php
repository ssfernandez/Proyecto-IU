...
<ul class="dropdown-menu" role="menu" id="contBandera">
            ...
            <li id="idioma"><?=IDIOMA?>: </li> //AQUI PUSE CAJA EN VERDE
            <li class="contBandera"><a href="../../Controllers/CAJA_Controller.php?idioma=esp&acc=Insertar"><IMG SRC="../../Assets/img/bespanha.gif" class="bandera"> Esp </a></li>
            <li class="contBandera"><a href="../../Controllers/CAJA_Controller.php?idioma=eng&acc=Insertar"><IMG SRC="../../Assets/img/buk.gif" class="bandera"> Eng </a></li>
          </ul>
        </div>
